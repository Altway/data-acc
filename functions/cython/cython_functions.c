...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "functions.cython.cython_functions",
        "sources": [
            "cython_functions.pyx"
        ]
    },
    "module_name": "functions.cython.cython_functions"
}
END: Cython Metadata */
...
#define __PYX_HAVE__functions__cython__cython_functions
#define __PYX_HAVE_API__functions__cython__cython_functions
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'functions.cython.cython_functions' */
...
static __pyx_t_5numpy_float64_t __pyx_f_9functions_6cython_16cython_functions_distance2(__Pyx_memviewslice, __Pyx_memviewslice, unsigned int); /*proto*/
...
#define __Pyx_MODULE_NAME "functions.cython.cython_functions"
extern int __pyx_module_is_main_functions__cython__cython_functions;
int __pyx_module_is_main_functions__cython__cython_functions = 0;

/* Implementation of 'functions.cython.cython_functions' */
...
static const char __pyx_k_functions_cython_cython_function[] = "functions.cython.cython_functions";
...
static PyObject *__pyx_n_s_functions_cython_cython_function;
...
/* "functions/cython/cython_functions.pyx":12
 * cimport cython
 * 
...
static __pyx_t_5numpy_float64_t __pyx_f_9functions_6cython_16cython_functions_distance2(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, unsigned int __pyx_v_N) {
  ...
  /* "functions/cython/cython_functions.pyx":13
 * 
 * cdef np.float64_t distance2(np.float64_t[:] a, np.float64_t[:] b, unsigned int N):
 *     cdef np.float64_t dist = 0             # <<<<<<<<<<<<<<
 *     cdef unsigned int i
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":15
 *     cdef np.float64_t dist = 0
 *     cdef unsigned int i
 *     for i in range(N):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "functions/cython/cython_functions.pyx":16
 *     cdef unsigned int i
 *     for i in range(N):
 *         dist += (a[i] - b[i]) * (a[i] - b[i])             # <<<<<<<<<<<<<<
 *     return dist
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":17
 *     for i in range(N):
 *         dist += (a[i] - b[i]) * (a[i] - b[i])
 *     return dist             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("functions.cython.cython_functions.distance2", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "functions/cython/cython_functions.pyx":22
...
/* Python wrapper */
static PyObject *__pyx_pw_9functions_6cython_16cython_functions_1SOR(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9functions_6cython_16cython_functions_1SOR = {"SOR", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9functions_6cython_16cython_functions_1SOR, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9functions_6cython_16cython_functions_1SOR(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("functions.cython.cython_functions.SOR", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9functions_6cython_16cython_functions_SOR(__pyx_self, __pyx_v_aa, __pyx_v_bb, __pyx_v_cc, __pyx_v_b, __pyx_v_w, __pyx_v_eps, __pyx_v_N_max);
...
static PyObject *__pyx_pf_9functions_6cython_16cython_functions_SOR(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_5numpy_float64_t __pyx_v_aa, __pyx_t_5numpy_float64_t __pyx_v_bb, __pyx_t_5numpy_float64_t __pyx_v_cc, __Pyx_memviewslice __pyx_v_b, __pyx_t_5numpy_float64_t __pyx_v_w, __pyx_t_5numpy_float64_t __pyx_v_eps, unsigned int __pyx_v_N_max) {
  ...
  /* "functions/cython/cython_functions.pyx":27
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":29
 *     cdef unsigned int N = b.size
 * 
 *     cdef np.float64_t[:] x0 = np.ones(N, dtype=np.float64)          # initial guess             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":30
 * 
 *     cdef np.float64_t[:] x0 = np.ones(N, dtype=np.float64)          # initial guess
 *     cdef np.float64_t[:] x_new = np.ones(N, dtype=np.float64)      # new solution             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":36
 *     cdef np.float64_t S
 * 
 ...
 */
  ...
  for (__pyx_t_3 = 1; __pyx_t_3 < __pyx_t_9; __pyx_t_3+=1) {
    ...
    /* "functions/cython/cython_functions.pyx":37
 * 
 *     for k in range(1,N_max+1):
 *         for i in range(N):             # <<<<<<<<<<<<<<
 *             if (i==0):
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "functions/cython/cython_functions.pyx":38
 *     for k in range(1,N_max+1):
 *         for i in range(N):
 *             if (i==0):             # <<<<<<<<<<<<<<
 *                 S = cc * x_new[1]
 ...
 */
      ...
      if (__pyx_t_13) {
        ...
        /* "functions/cython/cython_functions.pyx":39
 *         for i in range(N):
 *             if (i==0):
 *                 S = cc * x_new[1]             # <<<<<<<<<<<<<<
 *             elif (i==N-1):
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":40
 *             if (i==0):
 *                 S = cc * x_new[1]
 *             elif (i==N-1):             # <<<<<<<<<<<<<<
 *                 S = aa * x_new[N-2]
 ...
 */
      ...
      if (__pyx_t_13) {
        ...
        /* "functions/cython/cython_functions.pyx":41
 *                 S = cc * x_new[1]
 *             elif (i==N-1):
 *                 S = aa * x_new[N-2]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":43
 *                 S = aa * x_new[N-2]
 *             else:
 *                 S = aa * x_new[i-1] + cc * x_new[i+1]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":44
 *             else:
 *                 S = aa * x_new[i-1] + cc * x_new[i+1]
 *             x_new[i] = (1-w)*x_new[i] + (w/bb) * (b[i] - S)             # <<<<<<<<<<<<<<
 *         if distance2(x_new, x0, N) < eps*eps:
 ...
 */
    ...
    /* "functions/cython/cython_functions.pyx":45
 *                 S = aa * x_new[i-1] + cc * x_new[i+1]
 *             x_new[i] = (1-w)*x_new[i] + (w/bb) * (b[i] - S)
 *         if distance2(x_new, x0, N) < eps*eps:             # <<<<<<<<<<<<<<
 *             return x_new
 *         x0[:] = x_new
 */
    __pyx_t_13 = ((__pyx_f_9functions_6cython_16cython_functions_distance2(__pyx_v_x_new, __pyx_v_x0, __pyx_v_N) < (__pyx_v_eps * __pyx_v_eps)) != 0);
    if (__pyx_t_13) {

      /* "functions/cython/cython_functions.pyx":46
 *             x_new[i] = (1-w)*x_new[i] + (w/bb) * (b[i] - S)
 *         if distance2(x_new, x0, N) < eps*eps:
 *             return x_new             # <<<<<<<<<<<<<<
 *         x0[:] = x_new
 ...
 */
    ...
    /* "functions/cython/cython_functions.pyx":47
 *         if distance2(x_new, x0, N) < eps*eps:
 *             return x_new
 *         x0[:] = x_new             # <<<<<<<<<<<<<<
 *         if k==N_max:
 ...
 */
    ...
    /* "functions/cython/cython_functions.pyx":48
 *             return x_new
 *         x0[:] = x_new
 *         if k==N_max:             # <<<<<<<<<<<<<<
 *             print("Fail to converge in {} iterations".format(k))
 ...
 */
    ...
    if (__pyx_t_13) {
      ...
      /* "functions/cython/cython_functions.pyx":49
 *         x0[:] = x_new
 *         if k==N_max:
 *             print("Fail to converge in {} iterations".format(k))             # <<<<<<<<<<<<<<
 *             return x_new
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":50
 *         if k==N_max:
 *             print("Fail to converge in {} iterations".format(k))
 *             return x_new             # <<<<<<<<<<<<<<
 * 
...
/* "functions/cython/cython_functions.pyx":55
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_9functions_6cython_16cython_functions_3PSOR(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_9functions_6cython_16cython_functions_3PSOR = {"PSOR", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9functions_6cython_16cython_functions_3PSOR, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9functions_6cython_16cython_functions_3PSOR(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __pyx_t_5numpy_float64_t __pyx_v_aa;
  __pyx_t_5numpy_float64_t __pyx_v_bb;
  __pyx_t_5numpy_float64_t __pyx_v_cc;
  __Pyx_memviewslice __pyx_v_B = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("functions.cython.cython_functions.PSOR", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9functions_6cython_16cython_functions_2PSOR(__pyx_self, __pyx_v_aa, __pyx_v_bb, __pyx_v_cc, __pyx_v_B, __pyx_v_C, __pyx_v_w, __pyx_v_eps, __pyx_v_N_max);
...
static PyObject *__pyx_pf_9functions_6cython_16cython_functions_2PSOR(CYTHON_UNUSED PyObject *__pyx_self, __pyx_t_5numpy_float64_t __pyx_v_aa, __pyx_t_5numpy_float64_t __pyx_v_bb, __pyx_t_5numpy_float64_t __pyx_v_cc, __Pyx_memviewslice __pyx_v_B, __Pyx_memviewslice __pyx_v_C, __pyx_t_5numpy_float64_t __pyx_v_w, __pyx_t_5numpy_float64_t __pyx_v_eps, unsigned int __pyx_v_N_max) {
  ...
  /* "functions/cython/cython_functions.pyx":60
 *         np.float64_t w=1, np.float64_t eps=1e-10, unsigned int N_max = 500):
 * 
 *     cdef unsigned int N = B.size             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":62
 *     cdef unsigned int N = B.size
 * 
 *     cdef np.float64_t[:] x0 = np.ones(N, dtype=np.float64)          # initial guess             # <<<<<<<<<<<<<<
 *     cdef np.float64_t[:] x_new = np.ones(N, dtype=np.float64)       # new solution
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":63
 * 
 *     cdef np.float64_t[:] x0 = np.ones(N, dtype=np.float64)          # initial guess
 *     cdef np.float64_t[:] x_new = np.ones(N, dtype=np.float64)       # new solution             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":68
 *     cdef np.float64_t S
 * 
 *     for k in range(1,N_max+1):             # <<<<<<<<<<<<<<
 *         for i in range(N):
 ...
 */
  ...
  for (__pyx_t_3 = 1; __pyx_t_3 < __pyx_t_9; __pyx_t_3+=1) {
    ...
    /* "functions/cython/cython_functions.pyx":69
 * 
 *     for k in range(1,N_max+1):
 *         for i in range(N):             # <<<<<<<<<<<<<<
 *             if (i==0):
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "functions/cython/cython_functions.pyx":70
 *     for k in range(1,N_max+1):
 *         for i in range(N):
 *             if (i==0):             # <<<<<<<<<<<<<<
 *                 S = cc * x_new[1]
 ...
 */
      ...
      if (__pyx_t_13) {
        ...
        /* "functions/cython/cython_functions.pyx":71
 *         for i in range(N):
 *             if (i==0):
 *                 S = cc * x_new[1]             # <<<<<<<<<<<<<<
 *             elif (i==N-1):
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":72
 *             if (i==0):
 *                 S = cc * x_new[1]
 *             elif (i==N-1):             # <<<<<<<<<<<<<<
 *                 S = aa * x_new[N-2]
 ...
 */
      ...
      if (__pyx_t_13) {
        ...
        /* "functions/cython/cython_functions.pyx":73
 *                 S = cc * x_new[1]
 *             elif (i==N-1):
 *                 S = aa * x_new[N-2]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":75
 *                 S = aa * x_new[N-2]
 *             else:
 *                 S = aa * x_new[i-1] + cc * x_new[i+1]             # <<<<<<<<<<<<<<
 *             x_new[i] = (1-w)*x_new[i] + (w/bb) * (B[i] - S)
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":76
 *             else:
 *                 S = aa * x_new[i-1] + cc * x_new[i+1]
 *             x_new[i] = (1-w)*x_new[i] + (w/bb) * (B[i] - S)             # <<<<<<<<<<<<<<
 *             x_new[i] = x_new[i] if (x_new[i] > C[i]) else C[i]
 ...
 */
      ...
      *((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_x_new.data + __pyx_t_18 * __pyx_v_x_new.strides[0]) )) = (((1.0 - __pyx_v_w) * (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_x_new.data + __pyx_t_16 * __pyx_v_x_new.strides[0]) )))) + ((__pyx_v_w / __pyx_v_bb) * ((*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_B.data + __pyx_t_17 * __pyx_v_B.strides[0]) ))) - __pyx_v_S)));
      ...
      /* "functions/cython/cython_functions.pyx":77
 *                 S = aa * x_new[i-1] + cc * x_new[i+1]
 *             x_new[i] = (1-w)*x_new[i] + (w/bb) * (B[i] - S)
 *             x_new[i] = x_new[i] if (x_new[i] > C[i]) else C[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "functions/cython/cython_functions.pyx":79
 *             x_new[i] = x_new[i] if (x_new[i] > C[i]) else C[i]
 * 
 *         if distance2(x_new, x0, N) < eps*eps:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_13) {
      ...
      /* "functions/cython/cython_functions.pyx":80
 * 
 *         if distance2(x_new, x0, N) < eps*eps:
 *             print("Convergence after {} iterations".format(k))             # <<<<<<<<<<<<<<
 *             return x_new
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":81
 *         if distance2(x_new, x0, N) < eps*eps:
 *             print("Convergence after {} iterations".format(k))
 *             return x_new             # <<<<<<<<<<<<<<
 *         x0[:] = x_new
 ...
 */
    ...
    /* "functions/cython/cython_functions.pyx":82
 *             print("Convergence after {} iterations".format(k))
 *             return x_new
 *         x0[:] = x_new             # <<<<<<<<<<<<<<
 *         if k==N_max:
 ...
 */
    ...
    /* "functions/cython/cython_functions.pyx":83
 *             return x_new
 *         x0[:] = x_new
 *         if k==N_max:             # <<<<<<<<<<<<<<
 *             print("Fail to converge in {} iterations".format(k))
 ...
 */
    ...
    if (__pyx_t_13) {
      ...
      /* "functions/cython/cython_functions.pyx":84
 *         x0[:] = x_new
 *         if k==N_max:
 *             print("Fail to converge in {} iterations".format(k))             # <<<<<<<<<<<<<<
 *             return x_new
 ...
 */
      ...
      /* "functions/cython/cython_functions.pyx":85
 *         if k==N_max:
 *             print("Fail to converge in {} iterations".format(k))
 *             return x_new             # <<<<<<<<<<<<<<
 * 
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "functions.cython.cython_functions.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "functions.cython.cython_functions.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "functions.cython.cython_functions.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "functions.cython.cython_functions._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_functions_cython_cython_function, __pyx_k_functions_cython_cython_function, sizeof(__pyx_k_functions_cython_cython_function), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_functions__cython__cython_functions) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "functions.cython.cython_functions")) {
      if (unlikely(PyDict_SetItemString(modules, "functions.cython.cython_functions", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "functions/cython/cython_functions.pyx":7
 * """
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "functions/cython/cython_functions.pyx":8
 * 
 * import numpy as np
 * from scipy.linalg import norm             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *         np.float64_t[:] b,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9functions_6cython_16cython_functions_1SOR, NULL, __pyx_n_s_functions_cython_cython_function); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *         np.float64_t[:] B,  np.float64_t[:] C,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_9functions_6cython_16cython_functions_3PSOR, NULL, __pyx_n_s_functions_cython_cython_function); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_PSOR, __pyx_t_2) < 0) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "functions/cython/cython_functions.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Created on Mon Jul 29 11:13:45 2019
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init functions.cython.cython_functions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init functions.cython.cython_functions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
